...
public class YelpDBTest {
    ...
    public void test3() throws IOException {
        YelpDB database = new YelpDB("data/restaurants.json", "data/reviews.json", "data/users.json");
        YelpReview review = new YelpReview("{\"type\": \"review\", \"business_id\": \"1CBs84C-a-cuA3vncXVSAw\", \"votes\": {\"cool\": 0, \"useful\": 0, \"funny\": 0}, \"text\": \"Great pizza and salads!\", \"stars\": 4, \"user_id\": \"Tq13lhXLgpOQHmp9CxoIkA\", \"date\": \"2012-05-25\"}", database);
        assertEquals(false, database.containsReview(review.getId()));
        database.addReview(review);
        assertEquals(true, database.containsReview(review.getId()));
    }
}
